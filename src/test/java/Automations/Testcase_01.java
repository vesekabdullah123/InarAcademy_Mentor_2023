...
public class Testcase_01 {
    public static void main(String[] args) {
        ...
        String successMessage=driver.findElement(By.xpath("//p[normalize-space()='Your order has been received.']")).getText();
        Assert.assertEquals("Your order has been received.",successMessage);
        driver.close();
    }
}
