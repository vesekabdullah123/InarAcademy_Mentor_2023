...
public class Testcase_04 {
    public static void main(String[] args) {
        ...
        driver.findElement(By.cssSelector("input[id='phoneNumber']")).sendKeys("123");
        driver.findElement(By.xpath("(//button[normalize-space()='Place Order'])[1]")).click();
        String wrongPhoneNumberText=driver.findElement(By.xpath("//div[normalize-space()='Phone number must be 10 digits']")).getText();
        Assert.assertEquals("Phone number must be 10 digits",wrongPhoneNumberText);
        driver.close();
    }
}
